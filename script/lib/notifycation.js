      ...
      $.alert({
        ...
        buttons: {
          ...
          audio_vi: {
            text: "Thuyết minh",
            btnClass:
              arraySubType.length > 0 && arraySubType.includes("audio_vi")
                ? "btn-audio-vn"
                : "hidden",
            action: function () {
          ...
          audio_en: {
            text: "Audio En",
            btnClass:
              arraySubType.length > 0 && arraySubType.includes("audio_en")
                ? "btn-audio-en"
                : "hidden",
            action: function () {
          ...
          audio_jp: {
            text: "スピーカー",
            btnClass:
              arraySubType.length > 0 && arraySubType.includes("audio_jp")
                ? "btn-audio-jp"
                : "hidden",
            action: function () {
