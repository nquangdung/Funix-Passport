...
function reportIssue() {
	$.confirm(
		Notifycation.creatPrompt(function () {
...
function postReport(self) {
	...
	$.alert(
		Notifycation.creatLoadingAjax(function () {
			var self = this;
			self.showLoading(true);
			let request = {
				content: 'POST Request',
				requestUrl:
					'https://funix-onpage-translator.firebaseapp.com/add-ticket',
				requestBody: report,
			};
	...
	let requestSendMail = {
		content: 'POST Request',
		requestUrl:
			'https://funix-onpage-translator.firebaseapp.com/send-email-ticket',
